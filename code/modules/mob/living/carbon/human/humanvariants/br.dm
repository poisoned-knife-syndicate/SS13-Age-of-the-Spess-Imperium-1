...
/mob/living/carbon/human/whitelisted/bloodraven
	name = "Unknown"
	real_name = "Unknown"
	suicide_allowed = 0
	universal_speak = 1
...
/mob/living/carbon/human/whitelisted/bloodraven/New()
	..()
	sleep (5)
	...
	equip_to_slot_or_del(new /obj/item/clothing/suit/armor/BRpowerarmor, slot_wear_suit)
	...
	equip_to_slot_or_del(new /obj/item/clothing/head/helmet/BRhelmet, slot_head)
	...
	equip_to_slot_or_del(new /obj/item/weapon/tank/oxygen/BRback, slot_back)
